...
@onready var btn_forward : Button   = %BtnForward
@onready var btn_reload  : Button   = %BtnReload
...
@onready var input_senha : LineEdit = %InputSenha
@onready var modal_sub   : Label    = %ModalSub
