...
const EMAILS: Array[Dictionary] = [
	{
		"de": "RH - Belle Époque",
		"assunto": "Reunião de alinhamento - Quinta-feira",
		"hora": "14:03",
		"corpo": "Bom dia equipe,\n\nPassando para lembrar da reunião de alinhamento amanhã às 14h na sala principal.\n\nPor favor, tragam os relatórios atualizados do mês.\n\nAtenciosamente,\nRH - Belle Époque"
	},
	{
		"de": "Banco Infra",
		"assunto": "Transferência recebida",
		"hora": "22:43",
		"corpo": "Olá, Fabio Amaral.\n\nVocê recebeu uma transferência no valor de R$ 750.000,00 de:\n\nNova Horizon Consulting LTDA.\n\nA transação foi concluída com sucesso.\n\nData: 14/05 - 22:43\n\nObrigado por utilizar nossos serviços bancários."
	},
	{
		"de": "P.R.",
		"assunto": "Documentos removidos",
		"hora": "00:18",
		"corpo": "Fabio,\n\nOs documentos relacionados à Nova Horizon já foram removidos do servidor interno.\n\nComo combinado, essa operação não deve deixar rastros.\n\nRecomendamos apagar históricos, mensagens e arquivos temporários.\n\n- P.R."
	}
]
